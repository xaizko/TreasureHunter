...
public class Hunter {
    ...
    public boolean getSecretPirate(){
        return secretPirate;
    }
    /**
    ...
    public String getTreasures(){
        ...
        for(String treasure: treasures){
            if(treasure != null){
                printableTreasures += Colors.YELLOW + treasure + space + Colors.RESET;
            }
        }
    ...
    private int findTreasureInKit(String item) {
